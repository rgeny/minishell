...
#    Updated: 2022/02/07 12:50:50 by tokino           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC				= $(addsuffix .c,			main \
					...
					$(addprefix parser_,	tokens print n_create init_command free_ast main init_pipeline init_pipeline_list is_given_token) \
