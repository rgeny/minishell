...
#    Updated: 2022/02/07 11:56:50 by tokino           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC				= $(addsuffix .c,			main \
					...
					$(addprefix parser_,	tokens print n_create init_command free_ast main init_pipeline init_pipeline_list subshell_lvl) \
